...
function isMediaContentBlock(item) {
	...
	if ((0, _langchain_core_messages.isDataContentBlock)(item)) return item.source_type !== "text";
...
exports.convertGeminiPartToContentBlock = convertGeminiPartToContentBlock;
...
exports.geminiContentBlockConverter = geminiContentBlockConverter;
