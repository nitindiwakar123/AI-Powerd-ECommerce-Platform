const require_types = require("../chat_models/types.cjs");
...
function convertReasoningEffortToReasoningTokens(modelName, effort) {
	...
	const maxTokens = modelName?.startsWith("gemini-2.5-flash") ? 24576 : 32768;
...
function convertReasoningTokensToReasoningEffort(model, reasoningTokens) {
	if (typeof reasoningTokens === "undefined") return;
		...
		if (model?.startsWith("gemini-3-pro")) return "low";
		else return "minimal";
...
function convertFieldsToThinkingConfig(model, fields) {
	...
	if (modelSpecialty === "") {
		if (model.startsWith("gemini-2.5")) thinkingConfig.thinkingBudget = thinkingBudget;
...
function convertFieldsToServiceTier(platform, fields) {
	...
	if (!serviceTier || !require_types.settableServiceTier.includes(serviceTier)) return {};
	return { serviceTier };
}
//#endregion
exports.convertFieldsToServiceTier = convertFieldsToServiceTier;
...
exports.convertReasoningEffortToReasoningTokens = convertReasoningEffortToReasoningTokens;
exports.convertReasoningTokensToReasoningEffort = convertReasoningTokensToReasoningEffort;
exports.getModelLevel = getModelLevel;
exports.getModelSpecialty = getModelSpecialty;
